...
namespace Hw7
{
    public partial class Form1 : Form
    {
        ...
        readonly string highestScoreFilepath = "highest_score.txt";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var sr = new StreamReader(highestScoreFilepath))
                {
                    highestScore = int.Parse(sr.ReadToEnd());
                }
            }
            catch
            {
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if (bMoved)
            {
                ...
                if (IsGameOver())
                {
                    ...
                    {
                        highestScore = score;
                        using (var sw = new StreamWriter(highestScoreFilepath))
                        {
                            sw.Write(highestScore.ToString());
                        }
                        MessageBox.Show("Game over. You've reach the highest score, congratulations!");
                    }
                    else
                    {
        ...
        {
            if (radioButton1.Checked) gameMode = 0;
            pnlBoard.Focus();
        }

        private void radioButton2_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButton2.Checked) gameMode = 1;
            pnlBoard.Focus();
        }

        private void radioButton3_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButton3.Checked) gameMode = 2;
            pnlBoard.Focus();
        }
    }
